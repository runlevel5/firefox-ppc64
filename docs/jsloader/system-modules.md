...
modules loaded into the [DevTools distinct system global]).
...
The details around the migration is described in [the migration document](https://docs.google.com/document/d/1cpzIK-BdP7u6RJSar-Z955GV--2Rj8V4x2vl34m36Go/edit?usp=sharing).
